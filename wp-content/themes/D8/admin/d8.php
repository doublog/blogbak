...
<form method="post" class="d_formwrap">
    ...
    <tr>
        ...
        <td>
            ...
            <label class="checkbox inline">
                <input type="checkbox" id="d_post_from_b" name="d_post_from_b" <?php if(dopt('d_post_from_b')) echo 'checked="checked"' ?>>不显示来源
            </label> &nbsp; &nbsp; 
            <label class="checkbox inline">
                <input type="checkbox" id="d_post_cat_b" name="d_post_cat_b" <?php if(dopt('d_post_cat_b')) echo 'checked="checked"' ?>>不显示分类
            </label>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="d_tit">文章页 - 文章来源</td>
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_post_from_s" name="d_post_from_s" <?php if(dopt('d_post_from_s')) echo 'checked="checked"' ?>>开启
            </label>
        </td>
    </tr>
    <tr>
